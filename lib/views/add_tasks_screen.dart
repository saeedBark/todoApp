  ...
  Widget build(BuildContext context) {
    return BlocConsumer<TodoCubit, TodoState>(
      listener: (context, state) {
        ...
        if(state is SuccessUpdateDataFromTodoDatabaseState){
      ...
      builder: (context, state) {
        ...
        return Scaffold(
            appBar: AppBar(
              title:  Text('Add you tasks'.tr(),style: Theme.of(context).textTheme.bodyText1!.copyWith(color: Colors.white),),
              elevation: 1,
                    ...
                    child: Column(
                      children: [
                        ...
                        MaterialButton(
                          ...
                          child: Text('Add Task'.tr(),style: Theme.of(context).textTheme.bodyText1!.copyWith(color: Colors.white),),
